"""
This file generates the Topas scripts for the example.
It is called by the Optimizer object, and receives a dictionary of the current values of the variables.
...
def GenerateTopasScripts(BaseDirectory, iteration, **variable_dict):
    ...
    When it is called from an Optimizer object,it will receive a dictionary that contains the current values of
    the variables you set up in optimization_params when you initialized the optimizer.
    """
    ...
    SimpleCollimator.append(
        's:Sc/PhaseSpaceFromColl/OutputType                  = "Binary" '
    )
    SimpleCollimator.append(
        's:Sc/PhaseSpaceFromColl/OutputFile                   =  "../Results/coll_PhaseSpace_itt_'
        + str(iteration)
        + '"'
    )
    SimpleCollimator.append(
    ...
    WaterTank.append(
        's:Sc/PhantomScorer/OutputFile                   =  "../Results/WaterTank_itt_'
        + str(iteration)
        + '"'
    )
    WaterTank.append("")
